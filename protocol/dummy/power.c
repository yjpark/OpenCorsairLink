...
int corsairlink_dummy_output_select(struct corsair_device_info *dev,
...
int corsairlink_dummy_output_volts(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
			uint16_t *volts)
{
	int rr;
...
int corsairlink_dummy_output_amps(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
			uint16_t *amps)
{
	int rr;
...
int corsairlink_dummy_output_watts(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
			uint16_t *watts)
{
	int rr;
...
int corsairlink_dummy_power_supply_voltage(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
			uint16_t *supply)
{
	int rr;
...
int corsairlink_dummy_power_total_wattage(struct corsair_device_info *dev,
			struct libusb_device_handle *handle,
			uint16_t *watts)
{
	int rr;
