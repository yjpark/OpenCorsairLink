...
int corsairlink_dummy_fan_mode(struct corsair_device_info *dev, struct libusb_device_handle *handle,
	uint8_t fan_mode)
{
	int rr;
...
int corsairlink_dummy_fan_curve(struct corsair_device_info *dev, struct libusb_device_handle *handle,
